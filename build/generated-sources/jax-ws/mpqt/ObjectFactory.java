...
public class ObjectFactory {
    ...
    private final static QName _Operation_QNAME = new QName("http://MPQT/", "operation");
    private final static QName _OperationResponse_QNAME = new QName("http://MPQT/", "operationResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mpqt
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MPQT/", name = "operation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MPQT/", name = "operationResponse")
